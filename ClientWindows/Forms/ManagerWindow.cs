using PaxOnBoard.Client.Windows.Helpers;
...
namespace PaxOnBoard.Client.Windows.Forms
{
    public partial class ManagerWindow : Form
    {
        ...
        private void CheckMsfsStatus(object sender, EventArgs e)
        {
            ...
            if (_msfsDetected == LegacyHelper.MSFSinstallation.MSStore || _msfsDetected == LegacyHelper.MSFSinstallation.Steam)
            {
                ...
                if (_msfsRunning)
                {
                    ...
                    var xyz = SimConnectHelper.SimConnectHelper.RegisterSimVar(SimConnectHelper.SimConnectHelper.GetSimConnectVariableObject("TITLE"));
        ...
        {
            AppHelper.OpenUrl("https://github.com/KRtkovo-eu/PaxOnBoard/issues/new");
        }
        ...
        {
            AppHelper.OpenUrl("https://paxonboard.pro/");
        }
    }
}
